<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/QLBHAdmin.Master" AutoEventWireup="true" CodeBehind="QLNguonHangDetail.aspx.cs" Inherits="QLBH.Admin.QLNguonHangDetail" %>
      ...
      <div class="row">
		<div class="col-md-12">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Chi tiết nguồn hàng</div>
					...
					<div role="form">
						<fieldset>
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="name">Mã nguồn hàng:</label>
								<div class="col-md-10">
								<asp:TextBox runat="server" ID="txtMaNguonHang" CssClass="form-control"></asp:TextBox>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
								<asp:TextBox runat="server" ID="txtTenNguonHang" CssClass="form-control"></asp:TextBox>
									<span class="help-block">Vd:Công ty TNHH Thành Long </span>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="name">Người đại diện:</label>
								<div class="col-md-10">
								<asp:TextBox runat="server" ID="txtNguoiDaiDien" CssClass="form-control"></asp:TextBox>
