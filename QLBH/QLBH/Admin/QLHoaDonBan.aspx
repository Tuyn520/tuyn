<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/QLBHAdmin.Master" AutoEventWireup="true" CodeBehind="QLHoaDonBan.aspx.cs" Inherits="QLBH.Admin.QLHoaDonBan" %>
     ...
     <div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Quản Lý Hóa Đơn Bán</div>
					<div class="panel-body">
                        <asp:GridView AutoGenerateColumns="false"  runat="server" ID="dgvHoaDonBan" CssClass="cachtop" Height="237px" Width="100%">
                            
                            <Columns>
                                <asp:BoundField HeaderText="Hóa Đơn Bán" DataField="MaHoaDonBan"/>
                            </Columns>
                            <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                            ...
                            <Columns>
                                    <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <a ID="btnSua" href='<%# "QLHoaDonBanDetail.aspx?Ma=" + Eval("MaHoaDonBan").ToString() %>'>Sửa</a>
                                                    <a ID="btnChiTiet" href='<%# "QLChiTietHDB.aspx?Ma=" + Eval("MaHoaDonBan").ToString() %>'>Chi Tiết</a>
                            ...
                            <a href="QLHoaDonBanDetail.aspx" class="btn btn-primary">Thêm mới</a>
					</div>
				</div>
			</div>
		</div><!--/.row-->
