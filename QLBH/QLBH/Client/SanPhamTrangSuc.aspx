<%@ Page Title="" Language="C#" MasterPageFile="~/Client/QLBHClient.Master" AutoEventWireup="true" CodeBehind="SanPhamTrangSuc.aspx.cs" Inherits="QLBH.Client.SanPhamTrangSuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--banner-->
		<div class="banner1">
			<div class="container">
				<h3><a href="TrangChu.html">Trang Chủ</a> / <span>Trang Sức</span></h3>
			</div>
		</div>
	<!--banner-->
		<!--content-->
							...
							<div class="col-md-3 product-agileinfo-grid">
								<div class="categories">
									...
									<ul class="tree-list-pad">
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span>Kính</span></label>
											<ul>
														<li><a href="SanPhamTrangSuc.aspx">Kính cận</a></li>
														<li><a href="SanPhamTrangSuc.aspx">Kính râm</a></li>
											</ul>
										</li>
										<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1">Khuyên tai</label>
											<ul>
														<li><a href="SanPhamTrangSuc.aspx">Kính cận</a></li>
														<li><a href="SanPhamTrangSuc.aspx">Kính râm</a></li>
											</ul>
										</li>
										<li><input type="checkbox" checked="checked" id="item-2" /><label for="item-2">Nhẫn</label></li>
										<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1">Vòng tay/ Vòng cổ</label>
											<ul>
														<li><a href="SanPhamTrangSuc.aspx">Lắc tay/ chân</a></li>
														<li><a href="SanPhamTrangSuc.aspx">Choker/ Vòng cổ</a></li>
											</ul>
										</li>
										<li><input type="checkbox" checked="checked" id="item-2" /><label for="item-2">Phụ kiện tóc</label></li>
									</ul>
								</div>
								<div class="price">
									<h3>Giá tiền</h3>
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="TemplateClient/images/79265766_274419923777005_4145449249001038497_n.jpg" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="TemplateClient/images/106195725_650062645854482_5859688799546684407_n.jpg" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
