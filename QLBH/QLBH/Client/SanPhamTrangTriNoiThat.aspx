<%@ Page Title="" Language="C#" MasterPageFile="~/Client/QLBHClient.Master" AutoEventWireup="true" CodeBehind="SanPhamTrangTriNoiThat.aspx.cs" Inherits="QLBH.Client.SanPhamTrangTriNoiThat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="TrangChu.html">Trang Chủ</a> / <span>Trang Trí/ Nội Thất</span></h3>
			</div>
		</div>
	<!--banner-->
		<!--content-->
			<div class="content">
				<div class="products-agileinfo">
						<h2 class="tittle">Trang Trí/ Nội Thất</h2>
					<div class="container">
							...
							<div class="col-md-3 product-agileinfo-grid">
								<div class="categories">
									...
									<ul class="tree-list-pad">
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span>Trang trí</span></label>
											<ul>
														<li><a href="SanPhamTrangTriNoiThat.aspx">Đèn</a></li>
											</ul>
										</li>
										<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1">Nội thất</label>
										</li>
										<li><input type="checkbox" checked="checked" id="item-2" /><label for="item-2">Gấu bông/ Gối bông</label></li>
									</ul>
								</div>
								<div class="price">
									<h3>Giá tiền</h3>
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="TemplateClient/images/75576462_284366439348945_3623355909687590251_n.jpg" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="TemplateClient/images/106681700_2608774409365350_943060626217356573_n.jpg" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
